...
def instructions():
    print("""
    ***** Instructions *****
you must chose how many questions you want to play
...
# Main routine
print("Welcome To The Math questionare")
...
num_questions = int_check("how many questions do you want to complete ", 1)
